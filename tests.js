...
describe('isVowel', function () {
    ...
    it('should return true - isVowel("e")', function () {
        expect(isVowel("e")).toBe(true);
    });
    it('should return true - isVowel("i")', function () {
        expect(isVowel("i")).toBe(true);
    });
    it('should return true - isVowel("o")', function () {
        expect(isVowel("o")).toBe(true);
    });
    it('should return true - isVowel("u")', function () {
